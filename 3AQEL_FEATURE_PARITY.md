...
Soft-Magic AI currently covers a narrower but deeper workflow: product brief -> storyboard -> scene images -> final short ad video, with credits, Clerk billing, uploads, admin safety, abuse reports, and library.

The main gap is that 3aqel offers many standalone creation tools around images, audio, web pages, education, business advice, and video editing. Soft-Magic AI is currently focused on ad-video campaign generation.

## What Soft-Magic AI Already Has

| Area | Soft-Magic AI Status |
|---|---|
...
| Virtual product photography studio | Upload product photo, choose studio/background/lighting/angle, generate product shots | No | Large | Build product-photo tool using image-to-image model. Add presets for backgrounds, lighting, camera angle, batch up to 4 images, before/after gallery. This is high-value for Soft-Magic AI's SMB ad target. |
...
| Script writer | Full video scripts scene-by-scene by topic, duration, tone | Partial | Small/Medium | Soft-Magic AI already generates storyboard scripts. Expose it as standalone `/tools/script-writer` with duration/tone/platform fields and export/copy actions. |
...
| UGC/video ads expert | AI video ad with script/persona/VEO-style generation | Partial | Large | Package Soft-Magic AI's current workflow into a guided "video ad expert" wizard. Add UGC angles, hooks, persona, platform objective, product proof points. |
...
| Genius tutor | Arabic educational tutor with adaptive explanations/exercises | No | Medium | Specialized chat mode with lesson/exercise generation. Likely outside Soft-Magic AI's core SMB ad focus. |
| English tutor | English conversation, correction, grammar, exercises | No | Medium | Specialized chat mode with correction rubric and practice flows. Low strategic fit for Soft-Magic AI. |
...
## Highest-Value Parity Work For Soft-Magic AI

| Priority | Feature | Why |
|---:|---|---|
| 1 | Virtual product photography | Directly matches Soft-Magic AI's SMB ad/product-image audience and reuses uploads/image generation. |
...
Soft-Magic AI should avoid copying 3aqel as unrelated standalone pages bolted onto the app. The maintainable path is a shared tools framework.
...
Do not pursue all 3aqel tools equally. Their suite includes education, finance, lead-gen, and general chat tools that dilute Soft-Magic AI's current positioning. For feature parity that matters to the same customer, focus on campaign production:
...
That gives Soft-Magic AI parity where it matters for SMB advertising without turning the product into a generic AI toolbox.
