...
type CreativeAppKind = "text-to-image" | "image-editor" | "edit-studio" | "expand-image" | "stylize-image";
...
export function CreativeAppForm({
  ...
  async function onSubmit() {
    ...
    const payload = {
      ...
      style,
      aspectRatio,
      ...(app === "image-editor" || app === "expand-image" || app === "stylize-image" ? { sourceImageUrl: sourceUrl } : null),
