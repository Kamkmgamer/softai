...
export const dictionaries = {
  en: {
    ...
    legal: {
      ...
      termsUpdated: "Last updated: January 15, 2026",
      termsIntro:
        "These Terms of Service govern your use of Soft-Magic AI, an AI-powered media generation platform operated by Soft-Magic AI. By accessing or using our service, you agree to be bound by these terms.",
      termsAcceptTitle: "1. Acceptance of Terms",
      termsAcceptBody:
        "By creating an account or using Soft-Magic AI, you confirm that you are at least 18 years old and have the legal capacity to enter into a binding agreement. If you are using the service on behalf of an organization, you represent that you have the authority to bind that organization to these terms.",
      termsAccountTitle: "2. Account and Access",
      termsAccountBody:
        "Account authentication is provided through Clerk. You are responsible for maintaining the confidentiality of your account credentials and for all activity that occurs under your account. We reserve the right to suspend or terminate accounts that violate these terms.",
      termsCreditTitle: "3. Credits and Billing",
      termsCreditBody:
        "Soft-Magic AI uses a credit-based billing system. Credits are consumed each time you generate content. Credit costs vary by tool and output type. Billing and payment processing is handled through Polar.sh. All prices are in USD unless otherwise stated. Credits are non-transferable and do not expire.",
      termsAiTitle: "4. AI-Generated Content",
      termsAiBody:
        "You retain ownership of prompts, reference images, and other inputs you provide. Output generated by our AI tools is licensed to you for commercial and personal use. You may use generated content in advertisements, social media, educational materials, and other business purposes. We do not claim ownership over your generated outputs.",
      termsUseTitle: "5. Acceptable Use",
      termsUseBody:
        "You agree not to use the service to generate content that is illegal, harmful, fraudulent, sexually explicit, or that infringes on third-party rights. You may not attempt to reverse-engineer, decompile, or extract the underlying AI models. Automated or bulk access without written permission is prohibited.",
      termsIpTitle: "6. Intellectual Property",
      termsIpBody:
        "The Soft-Magic AI platform, including its interface, code, and AI models, is owned by Soft-Magic AI and protected by intellectual property laws. Your subscription grants you a limited, non-exclusive, non-transferable license to use the service.",
      termsLiabilityTitle: "7. Limitation of Liability",
      termsLiabilityBody:
        "Soft-Magic AI is provided \"as is\" without warranties of any kind. We are not liable for any indirect, incidental, or consequential damages arising from your use of the service. Our total liability shall not exceed the amount you paid for the service in the 12 months preceding the claim.",
      termsChangesTitle: "8. Changes to Terms",
      termsChangesBody:
        "We may update these terms from time to time. Material changes will be communicated via email or in-app notification. Continued use of the service after changes take effect constitutes acceptance of the updated terms.",
      termsContactTitle: "9. Contact",
      termsContactBody:
        "If you have questions about these Terms of Service, please contact us at support@softai.com.",
      privacyTitle: "Privacy Policy",
      privacyUpdated: "Last updated: January 15, 2026",
      privacyIntro:
        "This Privacy Policy describes how Soft-Magic AI collects, uses, and protects your personal information when you use our AI-powered media generation platform.",
      privacyCollectTitle: "1. Information We Collect",
      privacyCollectBody:
        "We collect information you provide directly: account details (name, email) through Clerk authentication, payment information processed by Polar.sh, uploaded images and videos, text prompts and project descriptions, and brand kit settings. We also collect usage data automatically: pages visited, features used, generation history, device type, browser, and IP address.",
      privacyUseTitle: "2. How We Use Your Information",
      privacyUseBody:
        "We use your information to provide and improve the service, process generations and deliver outputs, manage your account and billing, send service-related communications, detect and prevent fraud or abuse, and comply with legal obligations. We do not use your uploaded content or generated outputs to train AI models.",
      privacyShareTitle: "3. Information Sharing",
      privacyShareBody:
        "We share information with service providers who assist in operating our platform: Clerk (authentication), Polar.sh (payment processing), UploadThing (file storage), and AI model providers (content generation). These providers are contractually obligated to protect your data. We do not sell your personal information to third parties.",
      privacySecurityTitle: "4. Data Security",
      privacySecurityBody:
        "We implement industry-standard security measures including encrypted data transmission, secure storage, and access controls. However, no method of transmission or storage is 100% secure, and we cannot guarantee absolute security.",
      privacyRetentionTitle: "5. Data Retention",
      privacyRetentionBody:
        "We retain your account information for as long as your account is active. Generated content and uploaded files are retained until you delete them. You may request deletion of your data at any time by contacting support@softai.com.",
      privacyRightsTitle: "6. Your Rights",
      privacyRightsBody:
        "Depending on your jurisdiction, you may have the right to access, correct, delete, or port your personal data. You may also object to or restrict certain processing. To exercise these rights, contact us at support@softai.com.",
      ...
      privacyChangesBody:
        "We may update this Privacy Policy periodically. Material changes will be notified via email or in-app notice. The updated policy will be posted on this page with a revised date.",
      privacyContactTitle: "9. Contact",
      privacyContactBody:
        "For questions about this Privacy Policy, contact us at support@softai.com.",
      refundTitle: "Refund Policy",
      refundUpdated: "Last updated: January 15, 2026",
      refundIntro:
        "This Refund Policy explains when and how you can request a refund for credits or subscriptions purchased on Soft-Magic AI.",
      refundCreditTitle: "1. Credit Purchases",
      refundCreditBody:
        "Credits are consumed upon successful generation. If a generation fails due to a platform error and credits are deducted, the credits will be automatically refunded to your account. If you experience repeated failures, contact support@softai.com for assistance.",
      refundSubTitle: "2. Subscriptions",
      refundSubBody:
        "Subscription payments are processed through Polar.sh. If you cancel your subscription, you will retain access until the end of the current billing period. We do not offer partial refunds for unused portions of a billing period unless required by applicable law.",
      refundWindowTitle: "3. Refund Window",
      refundWindowBody:
        "Refund requests must be submitted within 14 days of the original purchase. Requests made after this period will be reviewed on a case-by-case basis. To request a refund, contact support@softai.com with your account email and order details.",
      refundNotTitle: "4. Non-Refundable Items",
      refundNotBody:
        "Credits that have been consumed for successful generations are non-refundable. Free trial credits and promotional credits are not eligible for refunds. We reserve the right to refuse refunds for accounts that violate our Terms of Service.",
      refundDisputeTitle: "5. Disputes",
      refundDisputeBody:
        "If you believe a charge was made in error, contact us before filing a dispute with your payment provider. We are committed to resolving billing issues promptly and fairly.",
      refundContactTitle: "6. Contact",
      refundContactBody:
        "For refund requests or billing questions, contact us at support@softai.com.",
    },
  },
  ar: {
    app: {
    ...
    legal: {
      ...
      termsUpdated: "آخر تحديث: 15 يناير 2026",
      termsIntro:
        "تحكم شروط الخدمة هذه استخدامك لـ Soft-Magic AI، منصة توليد الوسائط بالذكاء الاصطناعي التي تديرها Soft-Magic AI. bằng الوصول إلى خدمتنا أو استخدامها، أنت توافق على الالتزام بهذه الشروط.",
      termsAcceptTitle: "1. قبول الشروط",
      termsAcceptBody:
        "بإنشاء حساب أو استخدام Soft-Magic AI، أنت تؤكد أنك تبلغ من العمر 18 عاماً على الأقل وتمتلك الأهلية القانونية للentered into a binding agreement. إذا كنت تستخدم الخدمة نيابة عن مؤسسة، فأنت تصرح بأن لديك الصلاحية لربط تلك المؤسسة بهذه الشروط.",
      termsAccountTitle: "2. الحساب والوصول",
      termsAccountBody:
        "يتم توفير مصادقة الحساب من خلال Clerk. أنت مسؤول عن الحفاظ على سرية بيانات اعتماد حسابك وعن جميع النشاطات التي تحدث تحت حسابك. نحتفظ بحق تعليق أو إنهاء الحسابات التي تنتهك هذه الشروط.",
      termsCreditTitle: "3. الرصيد والفواتير",
      termsCreditBody:
        "تستخدم Soft-Magic AI نظام فواتير قائم على الرصيد. يُستهلك الرصيد في كل مرة تقوم فيها بإنشاء محتوى. تختلف تكاليف الرصيد حسب الأداة ونوع المخرجات. تتم معالجة الفواتير والمدفوعات من خلال Polar.sh. جميع الأسعار بالدولار الأمريكي ما لم يُذكر خلاف ذلك. الرصيد غير قابل للتحويل ولا ينتهي صلاحيته.",
      termsAiTitle: "4. المحتوى المولد بالذكاء الاصطناعي",
      termsAiBody:
        "أنت تحتفظ بالملكية للطلبات وصور المرجع والمدخلات الأخرى التي تقدمها. تُرخص المخرجات التي تولدتها أدوات الذكاء الاصطناعي لنا لاستخدامك التجاري والشخصي. يمكنك استخدام المحتوى المولد في الإعلانات ووسائل التواصل الاجتماعي والمواد التعليمية وأغراض العمل الأخرى. لا نطالب بالملكية على مخرجاتك المولدة.",
      termsUseTitle: "5. الاستخدام المقبول",
      termsUseBody:
        "أنت توافق على عدم استخدام الخدمة لإنشاء محتوى غير قاسي أو ضار أو احتيالي أو جنسي صراحةً أو ينتهك حقوق الأطراف الثالثة. يمكنك عدم محاولة عكس هندسة أو تفكيك أو استخراج نماذج الذكاء الاصطناعية الأساسية. الوصول الآلي أو الجماعي بدون إذن كتابي محظور.",
      termsIpTitle: "6. الملكية الفكرية",
      termsIpBody:
        "منصة Soft-Magic AI، بما في ذلك واجهتها وشيفرتها源代码 ونماذج الذكاء الاصطناعي، مملوكة لـ Soft-Magic AI ومحمية بقوانين الملكية الفكرية. يمنحك اشتراكك ترخيصاً محدوداً غير حصري وغير قابل للtransfer لاستخدام الخدمة.",
      termsLiabilityTitle: "7. تحديد المسؤولية",
      termsLiabilityBody:
        "تُقدم Soft-Magic AI \"كما هي\" دون أي ضمانات من أي نوع. نحن غير مسؤولين عن أي أضرار غير مباشرة أو عرضية أو تبعية ناتجة عن استخدامك للخدمة. مسؤوليتنا الإجمالية لا تتجاوز المبلغ الذي دفعته مقابل الخدمة في الاثني عشر شهراً السابقة للمطالبة.",
      termsChangesTitle: "8. التغييرات على الشروط",
      termsChangesBody:
        "قد نقوم بتحديث هذه الشروط من وقت لآخر. سيتم الإخطار بالتغييرات الجوهرية عبر البريد الإلكتروني أو إشعار داخل التطبيق. يشكّل الاستمرار في استخدام الخدمة بعد دخول التغييرات حيز التنفيذ قبولاً للشروط المحدثة.",
      termsContactTitle: "9. الاتصال",
      termsContactBody:
        "إذا كانت لديك أي أسئلة حول شروط الخدمة هذه، يرجى الاتصال بنا على support@softai.com.",
      privacyTitle: "سياسة الخصوصية",
      privacyUpdated: "آخر تحديث: 15 يناير 2026",
      privacyIntro:
        "تصف سياسة الخصوصية هذه كيف تجمع Soft-Magic AI معلوماتك الشخصية وتستخدمها وتحميها عندما تستخدم منصة توليد الوسائط بالذكاء الاصطناعي.",
      privacyCollectTitle: "1. المعلومات التي نجمعها",
      privacyCollectBody:
        "نجمع المعلومات التي تقدمها مباشرة: تفاصيل الحساب (الاسم، البريد الإلكتروني) من خلال مصادقة Clerk،معلومات الدفع المعالجة من Polar.sh،الصور والفيديوهات المرفوعة،والنصوص والوصف والمحتوى المُرسل. كما نجمع بيانات الاستخدام تلقائياً:الصفحات التي قمت بزيارتها والميزات التي قمت باستخدامها وسجل التوليد ونوع الجهاز والمتصفح وعنوان IP.",
      privacyUseTitle: "2. كيف نستخدم معلوماتك",
      privacyUseBody:
        "نستخدم معلوماتك لتقديم الخدمة وتحسينها ومعالجة عمليات التوليد وتوصيل المخرجات وإدارة حسابك وإرسال اتصالات تتعلق بالخدمة واكتشاف ومنع الاحتيال أوالإساءة والامتثال للالتزامات القانونية. لا نستخدم محتواك المرفوع أو مخرجاتك المولدة لتدريب نماذج الذكاء الاصطناعي.",
      privacyShareTitle: "3. مشاركة المعلومات",
      privacyShareBody:
        "نشارك المعلومات مع مزودي الخدمة которые يساعدون في تشغيل منصتنا: Clerk (المصادقة)، Polar.sh (معالجة المدفوعات)، UploadThing (تخزين الملفات)،ومزودي نماذج الذكاء الاصطناعي (توليد المحتوى). يُلزم هؤلاء المزودون تعاقدياً بحماية بياناتك. لا نبيع معلوماتك الشخصية لأطراف ثالثة.",
      privacySecurityTitle: "4. أمان البيانات",
      privacySecurityBody:
        "نطبق تدابير أمان معايير الصناعة بما في ذلك تشفير نقل البيانات والتخزين الآمن وضوابط الوصول. ومع ذلك،لا توجد طريقة نقل أو تخزين آمنة بنسبة 100%،لا نستطيع ضمان الأمان المطلق.",
      privacyRetentionTitle: "5. الاحتفاظ بالبيانات",
      privacyRetentionBody:
        "نحتفظ بمعلومات حسابك طالما أن حسابك نشط. يُحتفظ بالمحتوى المولد والملفات المرفوعة حتى تقوم بحذفها. يمكنك طلب حذف بياناتك في أي عن طريق الاتصال على support@softai.com.",
      privacyRightsTitle: "6. حقوقك",
      privacyRightsBody:
        "بناءً على ولايتك القضائية، قد يكون لديك الحق في الوصول إلى بياناتك الشخصية أوتصحيحها أوحذفها أونقلها. يمكنك أيضاً الاعتراض على معالجة معينة أوالتقييد منها. لممارسة هذه الحقوق، اتصل بنا على support@softai.com.",
      privacyCookiesTitle: "7. ملفات تعريف الارتباط",
      privacyCookiesBody:
        "نستخدم ملفات تعريف الارتباط الأساسية للمصادقة وإدارة الجلسة. لا نستخدم ملفات تعريف الارتباط الإعلانية أو التتبع. يمكنك إدارة تفضيلات ملفات تعريف الارتباط من خلال إعدادات المتصفح.",
      privacyChangesTitle: "8. التغييرات على هذه السياسة",
      privacyChangesBody:
        "قد نقوم بتحديث سياسة الخصوصية هذه بشكل دوري. سيتم إخطار التغييرات الجوهرية عبر البريد الإلكتروني أو إشعار داخل التطبيق. سيتم نشر السياسة المحدثة على هذه الصفحة مع تاريخ محدث.",
      privacyContactTitle: "9. الاتصال",
      privacyContactBody:
        "لديك أي أسئلة حول سياسة الخصوصية هذه، يرجى الاتصال بنا على support@softai.com.",
      refundTitle: "سياسة الاسترداد",
      refundUpdated: "آخر تحديث: 15 يناير 2026",
      refundIntro:
        "توضح سياسة الاسترداد هذه مت وكيف يمكنك طلب استرداد الأموال للرصيد أو الاشتراكات التي اشتريتها على Soft-Magic AI.",
      refundCreditTitle: "1. مشتريات الرصيد",
      refundCreditBody:
        "يُستهلك الرصيد عند نجاح عملية التوليد. إذا فشلت عملية التوليد بسبب خطأ في المنصة وتم خصم الرصيد،سيتم إعادة الرصيد تلقائياً إلى حسابك. إذا واجهت أخطاء متكررة، اتصل بـ support@softai.com للمساعدة.",
      refundSubTitle: "2. الاشتراكات",
      refundSubBody:
        "تتم معالجة مدفوعات الاشتراك من خلال Polar.sh. إذا قمت بإلغاء اشتراكك،ستحتفظ بالوصول حتى نهاية فترة الفوترة الحالية. لا نقدم استرداداً جزئياً للفترات غير المستخدمة من فترة الفوترة إلا إذا كان ذلك مطلوباً بموجب القانون المعمول به.",
      refundWindowTitle: "3. نافذة الاسترداد",
      refundWindowBody:
        "يجب تقديم طلبات الاسترداد خلال 14 يوماً من الشراء الأصلي. ستتم مراجعة الطلبات المقدمة بعد هذه الفترة بشكلCase by case. لطلب استرداد الأموال، اتصل بـ support@softai.com مع بريدك الإلكتروني للحساب وتفاصيل الطلب.",
      refundNotTitle: "4. العناصر غير المستردة",
      refundNotBody:
        "الرصيد الذي تم استهلاكه لتوليدات ناجحة غير مسترد. رصيد الفترة التجريبية المجانية ورصيد العروض الترويجية غير مؤهل للاسترداد. نحتفظ بحق رفض طلبات الاسترداد للحسابات التي تنتهك شروط الخدمة.",
      refundDisputeTitle: "5. النزاعات",
      refundDisputeBody:
        "إذا كنت تعتقد أن تم خصم رسوم عن طريق الخطأ، اتصل بنا قبل تقديم نزاع مع مزود الدفع. نحن ملتزمون بحل مشكلات الفوترة بسرعة وبشكل عادل.",
      refundContactTitle: "6. الاتصال",
      refundContactBody:
        "لطلبات الاسترداد أوالأسئلة المتعلقة بالفوترة، اتصل بنا على support@softai.com.",
    },
  },
} as const;
