        ...
        <div className="w-full max-w-282.5 rounded-[18px] bg-surface p-6 shadow-(--shadow-lg) ring-1 ring-border">
          ...
          <div className="grid gap-2 sm:grid-cols-2 xl:grid-cols-3">
            {[
              ...
              <div
                key={`${src}-${index}`}
                className="group relative aspect-video overflow-hidden rounded-[10px] bg-bg-subtle ring-1 ring-border"
              >
                <Image
                  src={src}
                  alt={alt}
                ...
                />
                <div className="absolute inset-0 bg-linear-to-t from-bg/75 via-transparent to-transparent opacity-70" />
