  ...
  return (
    <div className="flex min-h-screen flex-col bg-bg selection:bg-accent-soft selection:text-text">
      ...
      <main className="flex-1 overflow-hidden">
        {/* Hero Section */}
        <section className="relative mx-auto max-w-300 px-6 py-20 lg:py-32">
          <div className="grid gap-12 lg:grid-cols-[1.1fr_1fr] lg:gap-8 items-center">
            ...
            <div className="relative mx-auto w-full max-w-150 lg:max-w-none">
              ...
              {/* Decorative glow */}
              <div className="absolute -inset-x-10 -inset-y-10 -z-10 bg-linear-to-tr from-accent/20 via-transparent to-transparent blur-3xl opacity-50" />
            </div>
          </div>
        </section>
        ...
        <section className="border-y border-border bg-surface py-10">
          <div className="mx-auto flex max-w-300 flex-wrap justify-center gap-12 px-6 text-center sm:gap-24 lg:justify-start lg:text-start">
        ...
        {/* How it works */}
        <section className="mx-auto max-w-300 px-6 py-24 lg:py-32">
          ...
          <div className="grid gap-16 lg:grid-cols-[1fr_1.2fr] lg:gap-24 items-center">
            <div className="space-y-12">
              <div className="relative ps-12">
                <div
                  className={cn(
                    "absolute top-0 flex h-8 w-8 items-center justify-center rounded-full border border-border bg-surface text-sm font-semibold text-text shadow-(--shadow-sm)",
        ...
        <section className="border-t border-border bg-surface-raised py-24 lg:py-32">
          <div className="mx-auto max-w-300 px-6">
            <h2 className="mb-12 text-3xl font-semibold tracking-tight text-text sm:text-4xl text-center lg:text-start">
              {marketing.featuresTitle}
            </h2>

            <div className="grid gap-8 lg:grid-cols-[1.2fr_1fr]">
              <div className="group relative overflow-hidden rounded-lg border border-border bg-surface p-8 shadow-(--shadow-sm) transition-shadow hover:shadow-(--shadow-md)">
              ...
              <div className="flex flex-col gap-8">
                <div className="flex-1 rounded-lg border border-border bg-surface p-8 shadow-(--shadow-sm)">
